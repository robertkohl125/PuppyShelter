...
from puppyShelterDBsetup import Base, Puppy, Shelter
...
def showShelter():
	...
	for r in results:
		...
		print r[6]
		print '   Maximum Capacity: ',r[7]
		print '   Current Occupancy:',r[8]
		print "\n"
...
#countCurrentOccupancy()
#countUpdatedOccupancy()
#updateCurrentOccupancy()
#createShelterPuppyRow()
#showShelter()
#findLowestOccupancyShelter()
#calcCurrentOccDiff()
#testAvailability()